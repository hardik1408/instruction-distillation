...
def load_dataset(config):
    annotations_path = config["dataset"]["flower_test_annotations_path"]
...
def retrieve_hybrid_examples(image_name, k, k_prime, neighbors):
    """
    Retrieve k instruction and k_prime visual examples from precomputed neighbors.
    First k neighbors are instruction examples, next k_prime are visual examples.
    """
