...
def retrieve_similar_images(
    ...
    - train_image_ids : image ids of all train images
    - instructions_dict: instructions keyed by train image id
    ...
    for idx in sorted_indices:
        ...
        neighbor_id = str(train_image_ids[idx])
...
def run_inference(model_name, k, config):
    ...
    train_embeddings, train_image_ids = load_clip_embeddings(config)
    ...
    # Instructions are generated from train images
