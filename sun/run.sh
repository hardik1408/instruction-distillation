...
# python instruction_manual.py --model gemma-alt

# python approachone.py --model gemma-alt --k 1
# python approachone.py --model gemma-alt --k 2
# python approachone.py --model gemma-alt --k 3
# python approachone.py --model gemma-alt --k 5
# python approachone.py --model gemma-alt --k 10
# python approachone.py --model gemma-alt --k 25
...
python hybrid.py --model qwenn --k 10
